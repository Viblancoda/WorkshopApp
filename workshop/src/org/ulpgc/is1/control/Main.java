...
public class Main {
    private static void init(RepairManager repairManager) {
        ...
        Phone customerPhone2 = new Phone("678991125");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Vehículo: " + repairManager.getVehicle(1).getMake() + " " + repairManager.getVehicle(1).getModel());
        System.out.println("Matrícula: " + repairManager.getVehicle(1).getPlate().getPlate());
        System.out.println("Propietario: " + repairManager.getVehicle(1).getCustomer().getName());
        ...
        System.out.println("Vehículo reparado: " + vehicle.getMake() + " " + vehicle.getModel());
        System.out.println("Piezas modificadas: " + spareParts[0].getName() + " and " + spareParts[1].getName());

        System.out.println("------------Pago formalizado------------");
